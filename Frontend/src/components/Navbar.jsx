...
function Navbar() {
    ...
    return (
        <>
            <div className={`max-w-screen-2xl container mx:auto md:px-20 px-4 dark:bg-slate-900 dark:text-white fixed top-0 left-0 right-0 bg-base-200 z-50${sticky
                ...
                <div className="navbar">
                    <div className="navbar-start">
                        ...
                        <a className="text-3xl font-bold cursor-pointer hover:shadow-md">bookKWorld</a>
                    </div>
                    <div className='navbar-end space-x-3'>
                        ...
                        <div className='hidden md:block'>
                            <label className="px-3 py-2 border rounded-md flex items-center gap-2">
                                <input type="text" className="grow outline-none bg-base-100 dark:bg-slate-900 dark:text-white" placeholder="Search" />
